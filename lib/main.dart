...
// Future<void> main() async {
//   WidgetsFlutterBinding.ensureInitialized();
//   await AppInitializer().initialize(); //added this line here to try to see if notifs work
//   runApp(
//     ChangeNotifierProvider(
//       create: (context) => ThemeManager(),
//       child: const MyApp(),
...
//     super.key,
//     required this.title,
//     required this.diaryModel, //added
//   });

//   final String title;
//   final SleepDiaryModel diaryModel; // added
...
//                 onPressed: () => Navigator.push(
//                   context,
//                   MaterialPageRoute(builder: (context) => const SleepData()),
//                 ),
//               ),
